...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/octai-app/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "octai",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/octai-app/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "octai",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/octai-app",
			wantOwner:    "sipeed",
			wantRepoName: "octai",
			wantRef:      "main",
			wantSubPath:  "",
