# OctAi Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/octai/internal/gateway/`
...
import (
    "github.com/raynaythegreat/octai-app/pkg/bus"
    "github.com/raynaythegreat/octai-app/pkg/channels"     // Reference parent package
    "github.com/raynaythegreat/octai-app/pkg/config"
    "github.com/raynaythegreat/octai-app/pkg/identity"      // New
    "github.com/raynaythegreat/octai-app/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/octai/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/octai-app/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/raynaythegreat/octai-app/pkg/channels/discord"
    _ "github.com/raynaythegreat/octai-app/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/raynaythegreat/octai-app/pkg/channels"
    "github.com/raynaythegreat/octai-app/pkg/config"
    "github.com/raynaythegreat/octai-app/pkg/identity"
...
// cmd/octai/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/octai-app/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom OctAi native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
