# OctAi Channel System：完整开发指南

> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/octai/internal/gateway/`
...
import (
    "github.com/raynaythegreat/octai-app/pkg/bus"
    "github.com/raynaythegreat/octai-app/pkg/channels"     // 引用父包
    "github.com/raynaythegreat/octai-app/pkg/config"
    "github.com/raynaythegreat/octai-app/pkg/identity"      // 新增
    "github.com/raynaythegreat/octai-app/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/raynaythegreat/octai-app/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/raynaythegreat/octai-app/pkg/channels/discord"
    _ "github.com/raynaythegreat/octai-app/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 OctAi 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
